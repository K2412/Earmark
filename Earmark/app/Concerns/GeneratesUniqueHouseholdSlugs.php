...
trait GeneratesUniqueHouseholdSlugs
{
    /**
     * Generate a unique slug for the household.
     */
    protected static function generateUniqueHouseholdSlug(string $name, ?int $excludeId = null): string
    {
